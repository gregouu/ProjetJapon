...
<?php 
    ...
    $result = $pdo->prepare("SELECT * FROM profile WHERE id= :id");
    ...
    while($profile = $result->fetch(PDO::FETCH_ASSOC)){
?>  
        ...
        <div class="row">
                ...
                <div class="col-6">
                        <div class="centre">
                            ...
                            <figure><img src="<?php echo $profile['photo']; ?>" alt="photo de profile">
                            </figure>
                            <br>
                            <p class="nom"><?php echo $profile['nom']; ?></p>
                            <br>
                            <ul class="social-icons">
                                <li><a class="facebook" href="<?php echo $profile['facebook']; ?>" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                <li><a class="twitter" href="<?php echo $profile['twitter']; ?>" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                <li><a class="linkedin" href="<?php echo $profile['insta']; ?>" target="_blank"><i class="fa fa-instagram"></i></a></li>   
                            </ul>
                            <br>
